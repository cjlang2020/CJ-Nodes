...
app.registerExtension({
    name: "luy.animaStylePicker",
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        if (nodeData.name === "AnimaStylePickerNode") {
            console.log("初始化Anima画师风格选择器节点扩展");
            ...
            nodeType.prototype.onNodeCreated = function() {
                ...
                try {
                    iframe.src = "/CJ-Nodes/anima_style_prompt.html";
                } catch (e) {
...
console.log("Anima画师风格选择器节点扩展已加载");
