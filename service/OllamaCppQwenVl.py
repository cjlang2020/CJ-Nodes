...
preset_prompts = config_data["vl_prompts"]
...
class LoadllamaCppModel:
    ...
    def INPUT_TYPES(s):
        return {"required": {
            ...
            "model_type": (["None","Qwen3-VL", "Qwen2.5-VL", "LLaVA-1.5", "LLaVA-1.6", "Moondream2", "nanoLLaVA", "llama3-Vision-Alpha", "MiniCPM-v2.6", "MiniCPM-v4"], {"default": "Qwen3-VL"}),
    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                ...
                "custom_prompt": ("STRING", {"default": "", "multiline": True, "placeholder": "如果不空，就会替换上面选择的，除非是以@开头的会拼接！"}),
