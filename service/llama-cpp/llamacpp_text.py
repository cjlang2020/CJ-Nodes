...
preset_prompts = {
    ...
    "JSON - Describe": "Analyze this image in exhaustive JSON detail",
    ...
    def INPUT_TYPES(s):
        ...
        return {
            "required": {
                ...
                "preset_prompt": (preset_tags, {"default": "默认"}),
...
NODE_CLASS_MAPPINGS = {
    ...
    "llama_text_simple": llama_text_simple,
}
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "llama_text_simple": "Llama-cpp Text Simple",
}